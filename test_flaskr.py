...
class BookTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://postgres:Hari987@localhost:5432/bookshelf"
    ...
    def test_getbooks_withresult(self):
    ...
    def test_getbooks_without_result(self):
    ...
    def test_update_book_rating(self):
        res=self.client().patch('/books/1', json={'rating': 5})
        data=json.loads(res.data)
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertTrue(book.format()['rating'],5)
    ...
    def test_delete_book(self):
        res=self.client().delete('/books/11')
        data=json.loads(res.data)
    ...
    def test_404_book_doesnotexist(self):
    ...
    def test_405_bookcreation_not_possible(self):
